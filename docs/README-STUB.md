...
This behavior is defined by `json` library descriptor. Descriptors for all supported libraries can be found in [libraries](https://github.com/ileasile/kotlin-jupyter-libraries) repository.
...
```
You can also specify the source of library descriptor. By default, it's taken from the [libraries repository](https://github.com/ileasile/kotlin-jupyter-libraries). If you want to try descriptor from another revision, use the following syntax:
```
