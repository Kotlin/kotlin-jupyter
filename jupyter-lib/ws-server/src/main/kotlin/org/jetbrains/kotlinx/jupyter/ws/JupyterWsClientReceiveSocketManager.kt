...
class JupyterWsClientReceiveSocketManager(loggerFactory: KernelLoggerFactory) : JupyterClientReceiveSocketManager {
    ...
    private class WsClientReceiveSockets(private val delegate: JupyterClientSockets) : JupyterClientReceiveSockets {
