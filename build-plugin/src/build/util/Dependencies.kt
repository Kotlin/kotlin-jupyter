...
fun DependencyHandlerScope.testRuntimeOnly(dependency: Provider<MinimalExternalModuleDependency>) =
    addProvider(
        "testRuntimeOnly",
        dependency,
    )

fun DependencyHandler.shadowOf(projectDependency: ProjectDependency) = project(path = projectDependency.path, configuration = "shadow")
