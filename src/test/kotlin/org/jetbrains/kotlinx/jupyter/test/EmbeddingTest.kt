...
class EmbedReplTest : AbstractSingleReplTest() {
    ...
    fun testCustomClasses() {
        ...
        when (repl.compilerMode) {
            ...
            ReplCompilerMode.K2 -> {
                // See https://youtrack.jetbrains.com/issue/KTNB-978/K2-Repl-Some-custom-class-names-crash-the-compiler
                eval("val p = Point(1,1)").shouldBeInstanceOf<EvalResultEx.Error>()
            }
        }
    }
